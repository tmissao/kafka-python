...
def run():
    ...
    consume_messages(get_kafka_consumer(config.KAFKA_BOOTSTRAP_SERVERS, config.KAFKA_AVRO_TOPIC,
                                        config.KAFKA_AVRO_CONSUMER_GROUP_ID, config.SCHEMA_REGISTRY_URL))
